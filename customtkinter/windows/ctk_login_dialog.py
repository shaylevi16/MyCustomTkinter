...
class CTkLoginDialog(CTkToplevel):
    """
    ...
    def _create_widgets(self):
        ...
        self._entry1 = CTkEntry(master=self,
                               ...
                               font=self._font,
                               placeholder_text=self._place_holder_text[0])
        self._entry1.grid(row=1, column=0, columnspan=2, padx=20, pady=(0, 20), sticky="ew")
        ...
        self._entry2 = CTkEntry(master=self,
                               ...
                               text_color=self._entry_text_color,
                               font=self._font,
                               placeholder_text=self._place_holder_text[1],
                               show="*")
        self._entry2.grid(row=2, column=0, columnspan=2, padx=20, pady=(0, 20), sticky="ew")        
    ...
    def _ok_event(self, event=None):
        self._entry1.configure(border_color=self._entry_border_color)
        self._entry2.configure(border_color=self._entry_border_color)
        success, info = self._callback(self._entry1.get(), self._entry2.get())
        if success:
            self._result = info
            self._exit()
        else:
            self._entry1.configure(border_color="red")
            self._entry2.configure(border_color="red")
            if info == 0:
                self._exit()
